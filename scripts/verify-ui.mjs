...
check("ledger filters use a compact single-row toolbar", includesAll(css, [".ledger-filter-bar", "flex-wrap: wrap", ".ledger-keyword-field", "flex: 0 0 192px", ".ledger-owner-field", "flex: 0 0 152px", ".ledger-filter-actions"]));

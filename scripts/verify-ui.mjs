...
check("metric library and offline access center support experiment design", includesAll(app, ["renderMetricLibrary", "renderAccessCenter", "data-page-id=\"metrics\"", "data-page-id=\"access\"", "指标管理", "历史开始日期", "历史结束日期", "data-create-core-metric", "data-create-sample-range", "validateSampleSql", "resolveHistoricalSnapshot", "selectDemoAccount"]) && includesAll(css, [".metric-library-layout", ".demo-login", ".history-snapshot", ".access-request-list"]));
